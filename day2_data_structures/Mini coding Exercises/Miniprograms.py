...
fruits = ["apple", "banana", "cherry","Mango","Papaya","Orange"] #create a list
print(fruits)
print(len(fruits)) # len() is a built-in function which returns the length of the list
print(fruits[4]) #accessing elements of the list by index - starts from 0
print(fruits[-1]) #accessing the last element of the list ; -2 is the second last element and so on.
print(fruits[0:5]) #slicing - accessing multiple elements of the list within a range - start index included , end index excluded
print(fruits[1:])
print(fruits[-2:])
